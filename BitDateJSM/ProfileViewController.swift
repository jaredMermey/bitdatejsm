...
class ProfileViewController: UIViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        //creates title that sits in the middle of the nav bar. Instead of words we are using an icon called "profile-header"
        navigationItem.titleView = UIImageView(image: UIImage(named: "profile-header"))
        //creates right bar button item on the navigation with image "nav-back-button" that will call goToCards function
